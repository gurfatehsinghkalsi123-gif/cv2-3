...
cv2.rectangle(image_rgb, top_left1, bottom_right1, (191, 204, 22), 3)
...
cv2.rectangle(image_rgb, top_left2, bottom_right2, (0, 0, 255), 3)
...
cv2.putText(image_rgb, 'center1', (center1_x - 40, center1_y+40), font, 0.7, (0,255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'center2', (center2_x - 40, center2_y+40), font, 0.7, (0,255, 255), 2, cv2.LINE_AA)
...
cv2.putText(image_rgb, f"height: {height}px", height_label_position, font, 0.8, (255, 255, 0), cv2.LINE_AA)

plt.figure(figsize= (12,8))
plt.imshow(image_rgb)
plt.title("annotate image")
plt.axis("off")
plt.show()